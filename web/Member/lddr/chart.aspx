<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chart.aspx.cs" Inherits="Member_lddr_chart" MasterPageFile="~/Member/MemberMaster.master" %>
                ...
                <div class="cd-head">
                    ...
                    <div class="content">
                        <dl>
                            ...
                            <dd>
                                <a href="javascript:goLink('chart', 'lddr', 'jiben');" class="jiben">结果走势</a>
                            </dd>
                        </dl>
                        <dl>
                            <dt><span>定位走势:</span></dt>
                            <dd>
                                <a href="javascript:goLink('chart', 'lddr', 'startpos');" class="startpos">左右</a>
                                <a href="javascript:goLink('chart', 'lddr', 'laddercount');" class="laddercount">34</a>
                                <a href="javascript:goLink('chart', 'lddr', 'oddeven');" class="oddeven">单双</a>
                            </dd>
                        </dl>
                    </div>
                </div>
